...
export default defineConfig({
  ...
  head: [["link", { rel: "icon", href: "/frontend-interview/favicon.png" }]],
      ...
      "/react/": [
        {
          ...
          items: [
            ...
            { text: "React 19 新特性", link: "/react/react19" },
          ],
        },
      ],
      ...
      "/micro-frontend/": [
        {
          ...
          items: [
            ...
            { text: "Micro App", link: "/micro-frontend/micro-app" },
            {
              ...
              link: "/micro-frontend/module-federation",
            },
          ],
        },
      ],
